...
namespace InfiniTAM
{
	namespace Engine
	{
		...
		public:
			...
			void Initialise(int & argc, char** argv, InputSource::ImageSourceEngine *imageSource, InputSource::IMUSourceEngine *imuSource, InputSource::ExternalTrackerEngine *ExternalTracker, ITMLib::ITMMainEngine *mainEngine, const char *outFolder, ITMLib::ITMLibSettings::DeviceType deviceType, bool use_ros, bool dynamic_objects);
			void Shutdown();
