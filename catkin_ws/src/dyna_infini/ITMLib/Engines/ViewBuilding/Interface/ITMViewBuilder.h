...
namespace ITMLib
{
	...
	*/
	...
	public:
		...
		virtual void UpdateView(ITMView **view, ITMUChar4Image *rgbImage, ITMShortImage *rawDepthImage, bool useBilateralFilter, ITMUCharImage *maskImage = NULL, bool modelSensorNoise = false, bool storePreviousImage = true) = 0;
		virtual void UpdateView(ITMView **view, ITMUChar4Image *rgbImage, ITMShortImage *depthImage, bool useBilateralFilter, ITMIMUMeasurement *imuMeasurement, ITMUCharImage *maskImage = NULL, bool modelSensorNoise = false, bool storePreviousImage = true) = 0;
