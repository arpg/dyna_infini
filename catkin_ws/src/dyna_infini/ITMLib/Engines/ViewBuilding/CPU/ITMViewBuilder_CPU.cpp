...
void ITMViewBuilder_CPU::UpdateView(ITMView **view_ptr, ITMUChar4Image *rgbImage, ITMShortImage *rawDepthImage, bool useBilateralFilter, ITMUCharImage *maskImage, bool modelSensorNoise, bool storePreviousImage)
{ 
	if (*view_ptr == NULL)
	{
	...
	if(maskImage != NULL)
		view->mask_->SetFrom(maskImage, MemoryBlock<uchar>::CPU_TO_CPU);
	else
	    view->mask_ = NULL;
...
void ITMViewBuilder_CPU::UpdateView(ITMView **view_ptr, ITMUChar4Image *rgbImage, ITMShortImage *depthImage, bool useBilateralFilter, ITMIMUMeasurement *imuMeasurement, ITMUCharImage *maskImage, bool modelSensorNoise, bool storePreviousImage)
{
	if (*view_ptr == NULL)
	{
